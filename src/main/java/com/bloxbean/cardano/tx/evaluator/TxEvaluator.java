...
public class TxEvaluator {
    ...
    public List<Redeemer> evaluateTx(Transaction transaction, CostMdls costMdls) {
        ...
        ExBudget.ExBudgetByValue initialBudget = getInitialBudget();

        try {
            String costMdlsHex = HexUtil.encodeHexString(CborSerializationUtil.serialize(costMdls.serialize()));
            String response = null;
            response = CardanoJNAUtil.eval_phase_two_raw(transaction.serializeToHex(),
                    ...
                    costMdlsHex, initialBudget, slotConfig, true);
    ...
    private ExBudget.ExBudgetByValue getInitialBudget() {
        ExBudget.ExBudgetByValue initialBudget = new ExBudget.ExBudgetByValue();
        initialBudget.mem = 14000000;
        initialBudget.cpu = 10000000000L;
    ...
    public String evaluateTx(String txnHex, String inputs, String outputs, String costMdls) {
        ...
        String response = CardanoJNAUtil.eval_phase_two_raw(txnHex, inputs, outputs, costMdls, initialBudget, slotConfig, true);
